...
class AuditTrail:
    ...
    @staticmethod
    def registrar(
        usuario_id, empresa_id, acao, entidade, entidade_id, dados_old=None, dados_new=None
    ):
        """
    ...
    def get_historico_entidade(entidade, entidade_id, limite=50):
        ...
        logs = (
            LogAtividade.query.filter_by(entidade=entidade, entidade_id=entidade_id)
    ...
    def get_historico_empresa(
        ...
        return Paginacao(
            query.order_by(LogAtividade.created_at.desc()), page=page, per_page=per_page
        )
