...
def create_cli_commands(app):
    ...
    def migrate_roles():
        ...
        usuarios = Usuario.query.filter(Usuario.role.isnot(None), Usuario.role_id.is_(None)).all()
    ...
    def create_admin():
        ...
        try:
            ...
            if not usuario:
                ...
                print('   Email: admin@obraspro.com')
...
if __name__ == '__main__':
    ...
    app.run(debug=debug_mode, host='0.0.0.0', port=int(config('PORT', default='5000')))
